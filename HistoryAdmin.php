...
<head>
    ...
    position: fixed;
    overflow: auto;
    /* Set a minimum height to prevent the sidebar from becoming too small */
    min-height: 100%;
    /* Optionally, you can set a max-height if needed */
    max-height: 100%;
}
        .mainContent{
            height: 100%;
...
<body>
    <?php
        ...
        $sql = "SELECT `oId`, `oName`, `uId`, `price`, `photo`, `number`, `deliveryDate`, `status`, `pPrice`, `pQuantity` FROM `orders` WHERE `status` = 'successfull' ORDER BY deliveryDate DESC";
