...
<head>
  ...
  <style>
    #email {
      border: 0.5px solid;
      /* Set the border color to EAB76F */
      border-radius: 10px;
      /* Set the border radius to 10px for a rounded border */
      padding: 10px;
  ...
  <section class="vh-100" style="background-color: #eee;">
    ...
    <label class="form-label" for="email">Enter Your Email</label>
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  <img src="./images/sweet1.png" class="img-fluid" alt="Sample image" width="400px">
