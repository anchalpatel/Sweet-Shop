                ...
                if (mysqli_num_rows($result) < 1) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="col-3 mb-5 mt-2">
                            <form action="AddToCart.php" method="POST">
                                <div class="card cd shadow text-success" style="width: 17rem;">
                                    <img src="data:image/jpeg;base64,' . base64_encode($row['pImage']) . '" class="card-img-top" alt="..." height="200rem" width="300rem">
                        ...
                        if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
                            ...
                            echo ' <button name="update" style="border:none;outline:none background-color:none; color:#198754;"><i class="fa-solid fa-pen-to-square" style="font-size: 1.2rem; margin: 1rem 1.2rem;"></i></button>
                            ...
                            echo '<button type="submit" name="addCart" class="px-4 fs-6 py-1 border border-2 border-success rounded bt" onclick="">Add To Cart</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </form>
